...
{
    [Command(Name = "selenium.alertaction", Tooltip = "Waits for the alert and perform specific action.")]
    public class SeleniumAlertActionCommand : Command
    {
        public class Arguments : CommandArguments
        {
            [Argument(Required = true, Tooltip = "Specifies action, pissible values are: accept, dismiss")]
